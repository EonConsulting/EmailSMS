            ...
            <div class="col-sm-12">
                ...
                <form action="{{url('mail/sendmail') }}" method="POST" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="5" cols="20" class="form-control ckeditor" id="message"
                                  placeholder="Enter your Message" name="message">  </textarea>
                    </div>


                    <button type="submit" style="background: #172652 !important; border-color: #172652; color:#fff"
                            class="btn unisa-blue-btn">Submit
                    </button>
                    {{ csrf_field() }}
                </form>
            </div>
