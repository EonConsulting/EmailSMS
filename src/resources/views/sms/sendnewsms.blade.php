            ...
            <div class="col-sm-12">
                ...
                <form action="{{url('sms/bene') }}" method="POST" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id=""
                               placeholder="Enter phone number Format: 27823377985" name="to">
                    </div>
				...
				<input type="number" class="form-control" id="subject" placeholder="Enter phone number Format: 27823377985" value="{{Input::old('from')}}" name="from">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="5" cols="20" class="form-control ckeditor" id="textmessage"
                                  placeholder="Enter your Message" name="textmessage">  </textarea>
                    </div>

                    <button type="submit" class="btn btn-primary"
                            style="background: #F7931D !important; border-color: #F7931D; color:#fff;">Submit
                    </button>
                    {{ csrf_field() }}
                </form>
            </div>
